...
export const VoiceDemoCard = () => {
  ...
  return (
    <div className="bg-card rounded-3xl shadow-2xl border overflow-hidden">
      ...
      <div className="bg-gradient-to-r from-primary/10 via-primary/5 to-transparent p-4 md:p-6 border-b">
        ...
        <div className="flex items-center justify-center gap-6 md:gap-8 mt-4 md:mt-6">
          <div className="text-center">
            ...
            <p className="text-xs md:text-sm font-medium">Patient</p>
          ...
          <div className="text-center">
            ...
            <p className="text-xs md:text-sm font-medium">Pronto+</p>
      ...
      {/* Chat Messages */}
      <div className="overflow-y-auto p-4 space-y-3 h-[240px] md:h-[280px] bg-muted/20">
        {visibleMessages.length === 0 && !isCallActive && (
          <div className="flex items-center justify-center h-full text-muted-foreground text-center p-4 md:p-6">
            <p className="text-sm md:text-base">Click "Start Demo Call" to hear how Pronto+ handles a real patient inquiry about Invisalign</p>
          </div>
        )}
        ...
        {visibleMessages.map((message) => (
          ...
          >
            <div
              className={cn(
                "max-w-[85%] rounded-2xl px-3 py-2 md:px-4 md:py-3 shadow-sm",
                message.role === "pronto"
      ...
      {/* Call Controls */}
      <div className="p-4 md:p-5 border-t bg-background">
        <div className="flex justify-center gap-3">
          {!isCallActive ? (
            ...
            >
              {isComplete ? <RotateCcw className="w-4 h-4 md:w-5 md:h-5" /> : <Phone className="w-4 h-4 md:w-5 md:h-5" />}
